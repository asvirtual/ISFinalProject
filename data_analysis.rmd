...
Here we observe a statistically significant difference. The mean grade for single students is approximately **10.8**, whereas students in a romantic relationship have a mean grade of **9.6**. $p \approx 0.013$ confirms that this difference is unlikely to be due to chance.
...
**Travel Time:** There is a marginally significant effect of travel time (p $\approx$ 0.14), with a clear downward trend. Students with <15 min travel time average 10.8, while those with >3 hours average 8.75. Long commutes likely reduce available study time and increase fatigue.
...
p3 <- ggplot(residuals_refined, aes(sample = residuals)) +
  ...
  labs(title = "Normal Q-Q Plot (Refined)",
       subtitle = "Normality assumption more satisfied",
       x = "Theoretical Quantiles", y = "Standardized Residuals") +
  theme_minimal()
